...
<div class="order-history-wrapper">
    <div class="container">
        <form method="POST" action="" class="order-lookup-card">
            <input type="hidden" name="page" value="order_history"> <i class="fa-solid fa-receipt" style="font-size: 24px; color: var(--navy);"></i>
            <input type="text" name="phone" placeholder="Nhập số điện thoại đã đặt hàng của bạn...">
            <button type="submit" class="btn btn-navy">Tra cứu</button>
        </form><br><br>
                                                ...
                                                ?>
                                                    ...
                                                    <?php
                                                        if ($order['payment_status'] == 'unpaid'){
                                                            ?>
                                                                <a href="?page=pay_online&id=<?= $order['id'] ?>" class="btn-order btn-pay">
