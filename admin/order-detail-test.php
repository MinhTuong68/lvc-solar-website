...
<div class="wrapper">
    <div class="cs-page-wrapper">
        ...
        <button type="button" class="btn-primary" id="toggleAddProduct"><i class="fa-solid fa-plus"></i>Thêm sản phẩm</button><br><br>
        <div class="card-wrapper" id="cardwrapper"> 
            <div class="card-content">
                <h3 style="margin-bottom: 15px; color: var(--navy); display: flex; align-items: center; gap: 10px;">
                    <i class="fa-solid fa-utensils"></i> Menu Thêm Sản Phẩm
                </h3>
            ...
            <div class="od-main">
                <div class="od-card">
                    ...
                    <div class="od-card-body">
                        ...
                        //
                        <div class="card-flex" style="width:100%; justify-content: space-between;">
                        ...
                        <div class="od-card-body">
                            <div class="form-group-add" style="margin-bottom: 20px;">
                                ...
                                <select name="status" class="form-control" style="font-weight: 700;">
                                    ...
                                    <option value="done" <?= $order['status'] == 'done' ? 'done' : '' ?>>Hoàn thành</option>
